      ...
      if (np) {
        ...
        if (applyOnHttp) {
          ...
          if (http) {
            ...
            axios.interceptors.request.use(
              (request) => {
                if (!("showProgressBar" in request))
                  request.showProgressBar = applyOnHttp;
            ...
            axios.interceptors.response.use(
              ...
              (error) => {
                if (
                  (error.config && error.config.showProgressBar) ||
        ...
        if (router) {
          router.beforeEach((route, from, next) => {
            const showProgressBar =
              "showProgressBar" in route.meta
                ? route.meta.showProgressBar
                : applyOnRouter;
